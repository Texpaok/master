...
class plgSystemTracker extends JPlugin
{
	...
	function onAfterRoute()
	{
	// We show modal pop-up only to front-end visits
		if (JFactory::getApplication()->getName() == 'site') {
			$doc =& JFactory::getDocument();
			$doc->addScript('/media/com_joommark/javascript/jquery.js');
			$doc->addScript('/media/com_joommark/javascript/onpageload.js');
		}
	}
