...
<form action="index.php?option=com_joommark&view=messages" method="post" name="adminForm" id="adminForm">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<div class="btn-group pull-left">
			...
			<button class="btn tip" type="button" onclick="document.getElementById('filter_messages_search').value = '';
					this.form.submit();" rel="tooltip" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"><i class="icon-remove"></i></button>
		</div>
	</div>
